...
<!-- -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-. -->
                                       <td>
                                          ...
                                          <select name="Qty" id="" class="form-control"><!-- select Begin -->
                                                  <option value="<?php echo $pro_qty; ?>"> <?php echo $pro_qty; ?> </option>
                       ...
                       <div class="box-footer"><!-- box-footer Begin -->
                           ...
                           <div class="pull-right"><!-- pull-right Begin -->
                               ...
                               <a href="checkout.php" class="btn btn-primary">
                                   ...
                                   Proceder a Checar <i class="fa fa-chevron-right"></i>
                ...
                function update_cart(){
                    ...
                    if(isset($_POST['update'])){
                        ...
                        foreach($_POST['modificar_1'] as $upgrade_id){
                            ...
                            $upgrade_product = "update cart set qty = '$var' where p_id ='$upgrade_id'";

                            $run_upgrade = mysqli_query($con,$upgrade_product);
