...
$db = mysqli_connect("localhost","Edd","root","tienda_carros");
...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            echo "<script>alert('Este producto ya fue agragado a tu carrito')</script>";
        ...
        if($count==0){
            ...
            echo "
                ...
                <div class='box'>
                    ...
                    <h1> No Hay Productos Existentes en esta Categoria </h1>
                ...
                <div class='text'>
                    ...
                    <p class='button'>
                        ...
                        <a class='btn btn-primary' href='details.php?pro_id=$pro_id'>
                            ...
                            <i class='fa fa-shopping-cart'></i> Agrgar al Carrito
                    ...
                    <div class='product'>
                        ...
                        <p class='price'>
                            ...
                            <p class='buttons'>
                                ...
                                <i class='fa fa-shopping-cart'></i> Agrerar al carrito
