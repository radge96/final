   ...
   <div id="top"><!-- Top Begin -->
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="checkout.php"> <?php items(); ?> Items en tu Carrito | Precio Total: <?php total_price(); ?> </a>
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-collapse collapse" id="navigation"><!-- navbar-collapse collapse Begin -->
               ...
               <a href="../cart.php" class="btn navbar-btn btn-primary right"><!-- btn navbar-btn btn-primary Begin -->
                   ...
                   <span><?php items(); ?> Items en tu Carrito</span>
    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <h1 align="center"> Confirma tu Pago</h1>
                   ...
                   <form action="confirm.php?update_id=<?php echo $order_id;  ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> Seleccione Modo de Pago: </label>
                          ...
                          <select name="payment_mode" class="form-control"><!-- form-control Begin -->
                              ...
                              <option> Seleccione Modo de Pago </option>
                              <option> Codigo de Atras </option>
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> Codigo Paypall / Western Union : </label>
                   ...
                   <?php
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        if($run_pending_order){
                            ...
                            echo "<script>alert('Gracias por comprar, sus pedidos se completarán en 24 horas de trabajo')</script>";
