...
<h1 align="center"> Editar Cuenta </h1>
...
if(isset($_POST['update'])){
    ...
    if($run_customer){
        ...
        echo "<script>alert('Tu info. de cuenta ha sido actualizada, para completar el procesos, porfavor vuelva a iniciar sesion.')</script>";
