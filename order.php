...
//-->Quitar el renglo 19 y dejar de considerar este como comentario para funcionamiento correcto >> $status = "pending";
...
while($row_cart = mysqli_fetch_array($run_cart)){
    ...
    while($row_products = mysqli_fetch_array($run_products)){
        ...
        echo "<script>alert('Tu orden ha sido enviada')</script>";
